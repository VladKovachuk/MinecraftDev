...
public class PSDynamicRegistriesProvider extends FabricDynamicRegistryProvider {
    private final Set<String> namespaces = Set.of(Psychedelicraft.DEFAULT_NAMESPACE, Psychedelicraft.VANILLA_EXTENSIONS_NAMESPACE);

    public PSDynamicRegistriesProvider(FabricDataOutput output, CompletableFuture<WrapperLookup> registriesFuture) {
