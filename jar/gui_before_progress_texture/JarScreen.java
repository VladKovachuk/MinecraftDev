...
public class JarScreen extends HandledScreen<JarScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        context.drawTexture(TEXTURE, x, y, 0, 0, 176, 110, 176, 204);
        context.drawTexture(TEXTURE, x, y + 136, 0, 110, 176, 94, 176, 204);
        context.fill(x, y + 110, x + 176, y + 136, 0xFF17120C);
        context.fill(x + 2, y + 110, x + 174, y + 136, 0xFF6B5031);
        context.fill(x + 4, y + 110, x + 172, y + 136, 0xFF32281C);
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        context.drawCenteredTextWithShadow(textRenderer, counter, backgroundWidth / 2, 94, 0xF1DFC0);
        ...
        context.fill(10, 121, 166, 131, 0xFF17120C);
        context.fill(11, 122, 165, 130, 0xFF90734B);
        context.fill(12, 123, 164, 129, 0xFF24291C);
        int fill = Math.round(152 * handler.getCuringProgress());
        if (fill > 0) {
            context.fill(12, 123, 12 + fill, 129, 0xFF6E913C);
            context.fill(12, 123, 12 + fill, 125, 0xFFB6CC70);
            context.fill(12, 128, 12 + fill, 129, 0xFF425C26);
            context.fill(11 + fill, 123, 12 + fill, 128, 0xFFD7E79A);
        }
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (handler.isCuring() && mouseX >= x + 10 && mouseX < x + 166
                && mouseY >= y + 110 && mouseY < y + 131) {
